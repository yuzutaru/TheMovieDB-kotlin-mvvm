...
class MovieDataSource(private val movieRepository: MovieRepository, private val compositeDisposable: CompositeDisposable, private val type: String):
    ...
    override fun loadInitial(params: LoadInitialParams<Int>, callback: LoadInitialCallback<Int, MovieData>) {
        ...
        } else if (type == ARGUMENT_TOP_RATED) {
            compositeDisposable.add(
        ...
        } else if (type == ARGUMENT_NOW_PLAYING) {
            compositeDisposable.add(
